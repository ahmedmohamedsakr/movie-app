        ...
        if (state is NowPlayingMoviesLoadingState) {
          ...
          return FadeIn(
            ...
            child: CarouselSlider(
              ...
              items: MoviesCubit.get(context).nowPlayingMovies.map(
                (item) {
                    ...
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(builder: (context) {
                          // MoviesDetailsCubit.get(context).getMovieDetails(movieId: item.id);
                          // MoviesDetailsCubit.get(context).getMovieRecommendations(movieId: item.id);
